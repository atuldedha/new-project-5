...
return (
    ...
    <Container fluid>
        <Navbar.Brand href="#home">Influencer Panel</Navbar.Brand>
        <Navbar.Toggle />
        ...
        <div className="profileDiv">
            <a href="#"className="navbar-brand name">Minhas Asif</a>
            <img src="/Images/profile-circle-2 1profil.png" alt="profile"/>
            <svg className="svgDropDown" width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.58707 1.25L6.0965 5.75L10.6059 1.25" stroke="white" stroke-width="2.25472" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
        </Navbar.Collapse>
    </Container>
