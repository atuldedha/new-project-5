  ...
  return (
    <div className='sidebar'>
        ...
        <div className='BTNsEC'>
            ...
            <Link href="/influencer"  onClick={ () => {handleSwitch("Infu")}}>
            <div  className={` switchBtn ${isActive === "Infu" ? "activeBtnSide" : "inactiveBtn"}`}><Image src={Influencers} alt="dash"/>&nbsp;Influencers</div></Link>
            <Link href="/clients"onClick={ () => {handleSwitch("Cli")}}>
            <div className={` switchBtn ${isActive === "Cli" ? "activeBtnSide" : "inactiveBtn"}`}><Image src={Clients} alt="dash"/>&nbsp;Clients</div></Link>
            <Link href="/campaigns" onClick={ () => {handleSwitch("Camp")}}>
            <div className={` switchBtn ${isActive === "Camp" ? "activeBtnSide" : "inactiveBtn"}`}><Image src={Campaigns} alt="dash"/>&nbsp;Campaigns</div></Link>
            <Link href="/reports"onClick={ () => {handleSwitch("Rep")}}>
            <div className={` switchBtn ${isActive === "Rep" ? "activeBtnSide" : "inactiveBtn"}`}><Image src={Reports} alt="dash"/>&nbsp;Reports</div></Link>
        </div>
    </div>
  )
}
